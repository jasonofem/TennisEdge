  ...
  const fetchLiveData = async () => {
    ...
    try {
      ...
      if (data.success && data.matches?.length > 0) {
        ...
        setApiStatus({
          connected: false,
          message: data.error || "No matches found",
          error: data.details || ""
        });
        setMatches([]);
      }
    ...
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          {loading ? (
            ...
            <EmptyState
              ...
              description="No tennis matches available. Go to Settings to add your API key."
              variant="awaiting"
                  ...
                  return (
                    <div key={m.id} className="flex justify-between items-center p-3 rounded-lg bg-black/40 border border-cyan-500/10">
                      ...
                      <div className="text-right">
                        <div className="text-cyan-400 font-mono text-sm">{m.tournament}</div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card className="border-cyan-500/20 bg-black/60 backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="text-lg font-mono text-cyan-400">System Status</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
